...
const ExamListPage = async ({ searchParams }: PageProps) => {
  ...
  const { page, ...queryParams } = filteredParams;
  ...
  switch (role) {
    ...
    case "teacher":
      ...
      break;
    case "student":
      (query.lesson as any).class = { students: { some: { id: currentUserId! } } };
      break;
    case "parent":
      (query.lesson as any).class = { students: { some: { parentId: currentUserId! } } };
      break;
  }
