    ...
    return (
        ...
        <div className="w-full xl:w-2/3">
            ...
            <div className=" flex flex-col lg:flex-row gap-4">
                ...
                <div className="bg-myBrown px-8 py-6 rounded-md flex-1 flex gap-4">
                    <div className="w-1/3">
                        <Image src="/teacher1.png" alt="Teacher" width={144} height={144} className="rounded-full w-36 h-36 object-cover" />
                    </div>
                    <div className="w-2/3 flex flex-col justify-between gap-4">
                    <div className="flex items-center gap-4">
                        <h1 className="text-lg font-semibold">Edward Clark</h1>
                        <FormModal table="teacher" type="update" data={{}} />
                    </div>
                    <p className="text-sm text-gray-500">A mathematics teacher with over 25years of experience. He had his masters in Mathematics from Harvard University.</p>
                    <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium mt-2">
                        ...
                        <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                            ...
                            <span>edwardclark@gmail.com</span>
                        </div>
                        <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                ...
                <div className="flex-1 flex gap-4 justify-between flex-wrap">
                    ...
                    <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w[48%] xl:w-[45%] 2xl:w-[48%]">
                        ...
                        <div className="">
                            <h1 className="text-lg font-semibold">12</h1>
        ...
        <div className="bg-white p-4 rounded-md">
            ...
            <div className="mt-4 flex gap-4 flex-wrap text-sm text-gray-500">
                <Link className="p-3 rounded-md bg-myBrown" href="/">Teacher's Classes</Link>
                <Link className="p-3 rounded-md bg-myBlue" href="/">Teacher's Students</Link>
                <Link className="p-3 rounded-md bg-gray-200" href="/">Teacher's Lessons</Link>
                <Link className="p-3 rounded-md bg-secondary text-white" href="/">Teacher's Exams</Link>
                <Link className="p-3 rounded-md bg-gray-200" href="/">Teacher's Assignment</Link>
            </div>
        </div>
            <Performance />
            <Announcements />
