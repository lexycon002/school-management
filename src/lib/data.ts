...
export const subjectsData = [
  {
    ...
    course_code: "CSC 306",
    lecturer: ["Dr Haastrup", "Russell Davidson"],
  },
  {
    id: 2,
    name: "Algorithm and Complexity Analysis",
    course_code: "CSC 302",
    lecturer: ["Manuel Becker", "Eddie Chavez"],
  },
  {
    id: 3,
    name: "Technology Management and Professional issues",
    course_code: "CSC 101",
    lecture: ["Alice Phelps", "Russell Davidson"],
  },
  {
    id: 4,
    name: "Research Methodology",
    course_code: "CSC 202",
    lecturer: ["Nathan Kelly", "Benjamin Snyder"],
  },
  {
    id: 5,
    name: "Discrete Mathematics, Network and Graph Theory",
    course_code: "CSC 303",
    lecturer: ["Alma Benson", "Lina Collier"],
  },
  {
    id: 6,
    name: "Computer Graphics",
    course_code: "CSC 304",
    lecturer: ["Hannah Bowman", "Betty Obrien"],
  },
  {
    id: 7,
    name: "Biometric",
    course_code: "CSC 305",
    lecturer: ["Lora French", "Sue Brady"],
  },
];
...
export const classesData = [
  {
    ...
    name: "CSC 302",
    capacity: 120,
    lecturer: "Joseph Padilla",
  },
  {
    id: 2,
    name: "CSC 304",
    capacity: 22,
    lecturer: "Blake Joseph",
  },
  {
    id: 3,
    name: "CSC 306",
...
export const calendarEvents = [
  ...
  {
    title: "Technology Management and Professional",
    allDay: false,
  ...
  {
    title: "Discrete Mathematics, Network and Graph Theory",
    allDay: false,
    start: new Date(year, month, startDay + 2, 11, 0),
    end: new Date(year, month, startDay + 2, 11, 45),
  },
  {
    title: "Computer Graphics",
    allDay: false,
    start: new Date(year, month, startDay + 3, 13, 0),
    end: new Date(year, month, startDay + 3, 13, 45),
  },
  {
    title: "Biometrics",
    allDay: false,
